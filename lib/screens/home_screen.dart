...
import 'geschichten_screen.dart';
...
// HOME SCREEN
// ============================================================
// StatefulWidget because it needs to REMEMBER which
// bottom-nav button the user tapped last.
// ============================================================
...
class _HomeScreenState extends State<HomeScreen> {
  // 0 = Lernen, 1 = Geschichten, 2 = Übungen, 3 = Fortschritt
  int _currentIndex = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // IndexedStack = stack of cards, only the top one is visible.
      body: IndexedStack(
        index: _currentIndex,
        children: [
          _buildLernenTab(),
          const GeschichtenScreen(),
          const UebungenScreen(),
        ...
        child: SafeArea(
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                _navItem(Icons.school, 'Lernen', _currentIndex == 0, () {
                  setState(() => _currentIndex = 0);
                }),
                _navItem(Icons.auto_stories, 'Geschichten', _currentIndex == 1,
                    () {
                  setState(() => _currentIndex = 1);
                }),
                _navItem(Icons.quiz_outlined, 'Übungen', _currentIndex == 2,
                    () {
                  setState(() => _currentIndex = 2);
                }),
                _navItem(Icons.show_chart, 'Fortschritt', _currentIndex == 3,
                    () {
  ...
  // ==========================================================
  // LERNEN TAB CONTENT (your existing home content)
  // ==========================================================
  Widget _buildLernenTab() {
    return SafeArea(
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Hallo, Amir',
                        style: AppTypography.germanTitle.copyWith(fontSize: 22),
                      ),
            ...
            // LEVEL CARDS
            ...levels.map((level) => _buildLevelCard(context, level)),
          ],
        ),
      ),
    );
